...
- (instancetype)initWithTrack:(MIKMIDITrack *)track
{
    if (self = [super init]) {
        ...
        if (err) {
            NSLog(@"NewMusicEventIterator() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
            return nil;
        }
    }
    return self;
...
- (void)dealloc
{
    ...
    if (err) NSLog(@"DisposeMusicEventIterator() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
}
...
- (BOOL)seek:(MusicTimeStamp)timeStamp
{
    ...
    if (err) NSLog(@"MusicEventIteratorSeek() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
    return !err;
}
...
- (BOOL)moveToNextEvent
{
    ...
    if (err) NSLog(@"MusicEventIteratorNextEvent() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
    return !err;
}
...
- (BOOL)moveToPreviousEvent
{
    ...
    if (err) NSLog(@"MusicEventIteratorPreviousEvent() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
    return !err;
}
...
- (MIKMIDIEvent *)currentEvent
{
    ...
    if (err) {
        NSLog(@"MusicEventIteratorGetEventInfo() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
        return nil;
    }
...
- (BOOL)hasPreviousEvent
{
    ...
    if (err) NSLog(@"MusicEventIteratorHasPreviousEvent() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
...
- (BOOL)hasCurrentEvent
{
    ...
    if (err) NSLog(@"MusicEventIteratorHasCurrentEvent() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
...
- (BOOL)hasNextEvent
{
    ...
    if (err) NSLog(@"MusicEventIteratorHasNextEvent() failed with error %d in %s.", (int)err, __PRETTY_FUNCTION__);
